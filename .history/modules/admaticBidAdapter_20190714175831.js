  ...
  */
  buildRequests: function (validBidRequests, bidderRequest) {
    ...
    for (var i = 0; i < validBidRequests.length; i++) {
      ...
      payload.url = bidderRequest.refererInfo.referrer;
      payload.bidderRequest = bidderRequest;
      console.log(bidderRequest);
      if (typeof (payload.nocount) != 'undefined') { payload.nocount = validBidRequest.params.nocount; }
      payload.screen = {
        width: screen.width,
